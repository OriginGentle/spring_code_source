...
public interface MergedBeanDefinitionPostProcessor extends BeanPostProcessor {
	 ...
	 */
	void postProcessMergedBeanDefinition(RootBeanDefinition beanDefinition, Class<?> beanType, String beanName); // spring通过此方法找出所有需要注入的字段，同时做缓存
	 ...
	 */
	default void resetBeanDefinition(String beanName) { // 用于在BeanDefinition被修改之后，清楚容器的缓存
	}
